      ...
      <Container>
        <GenericHtml>
          ...
          <ul>
            ...
            <li><strong>4. After 4 cycles, take a long break</strong> (usually 15–30 minutes).</li>
          </ul>
          ...
          <h3>
            <RefreshCw className={styles.iconSection} /> Organized cycle sequence
          </h3>
          <p>
          ...
          <p><strong>Our default:</strong></p>
          <ul>
            <li><strong>Odd</strong> cycles: Work (focus).</li>
            <li><strong>Even</strong> cycles: Short break.</li>
            <li>Cycle <strong>8</strong>: Special long break to reset the full cycle.</li>
          </ul>
          ...
          <ul className="space-y-1">
            ...
            <li className="flex items-center gap-2">
              <Circle className={styles.longBreakDot} /> Long break (every 8 cycles)
            </li>
          </ul>
          ...
          <p>
            ...
            <a href="/history">history</a>, with statuses such as completed or
            interrupted. This helps you track your progress over time.
          </p>
